class FormGenerator {
    ...
    extraFields(fieldType) {
        ...
        if (this.fieldType == 'file') {
            ...
            addNew = `<button type="button" class="btn btn-sm btn--primary addOption"><i class="fa-solid fa-plus me-0"></i></button>`;
        ...
        return `
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button class="btn btn--danger input-group-text removeOption"><i class="fa-solid fa-x"></i></button>
                </div>
            </div>
        `;
    }
    ...
    makeFormHtml(formItem, updateId) {
        ...
        var formsHtml = `
            ...
            <div class="card-body">
                <div class="button--group d-flex align-items-center justify-content-end gap-2">
                    <button type="button" class="edit--btn editFormData" data-form_item='${JSON.stringify(formItem)}' data-update_id="${updateId}"><i class="fa-solid fa-pen-to-square"></i></button>
                    <button type="button" class="btn btn--danger removeFormData"><i class="fa-regular fa-trash-can"></i></button>
                </div>
                <div class="form-group">
                    <label>Label</label>
        ...
        var html = `
            <div class="col-xl-4">
                <div class="card radius--base br--solid overflow-hidden" id="${updateId}">
                    ${formsHtml}
                </div>
            </div>
        `;
            ...
            if (i == 0) {
                html += `
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <button type="button" class="btn btn-sm btn--primary addOption"><i class="fa-solid fa-plus me-0"></i></button>
                    </div>
                `;
            }
            i += 1;
