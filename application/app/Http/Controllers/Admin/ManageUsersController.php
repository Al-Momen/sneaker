...
class ManageUsersController extends Controller
{
    ...
    {
        return $this->renderUserList(null, 'All Users');
    }
    ...
    protected function userData($scope = null){
        ...
        $kycVerifiedUser = (clone $summaryQuery)->kycVerified()->count();
        $kycVerifiedUserPercent = ($totalUser > 0) ? number_format((($kycVerifiedUser / $totalUser) * 100), 2) : 0;
        ...
        $users =  $baseQuery->searchable(['username','email'])->orderBy('id','desc')->paginate(getPaginate());
        ...
        return [
            ...
            'summery'=>[
                ...
                'kyc_verified_user'=>$kycVerifiedUser,
                'kyc_verified_user_percent'=>$kycVerifiedUserPercent,
    ...
    private function renderUserList($scope = null, $pageTitle = 'All Users')
    {
        ...
        $widget = [
            ...
            'kyc_verified_user' => $summery['kyc_verified_user'],
            'kyc_verified_user_percent' => $summery['kyc_verified_user_percent'],
    ...
    {
        return $this->renderUserList('active', 'Active Users');
    }

    public function bannedUsers()
    {
        return $this->renderUserList('banned', 'Banned Users');
    }

    public function emailUnverifiedUsers()
    {
        return $this->renderUserList('emailUnverified', 'Email Unverified Users');
    }

    public function kycUnverifiedUsers()
    {
        return $this->renderUserList('kycUnverified', 'KYC Unverified Users');

    }
    public function kycVerifiedUsers()
    {
        return $this->renderUserList('kycVerified', 'KYC Verified Users');
    }

    public function kycPendingUsers()
    {
        return $this->renderUserList('kycPending', 'KYC Unverified Users');
    }

    public function emailVerifiedUsers()
    {
        return $this->renderUserList('emailVerified', 'Email Verified Users');
    }


    public function mobileUnverifiedUsers()
    {
        return $this->renderUserList('mobileUnverified', 'Mobile Unverified Users');
    }


    public function mobileVerifiedUsers()
    {
        return $this->renderUserList('mobileVerified', 'Mobile Verified Users');
    }


    public function usersWithBalance()
    {
        return $this->renderUserList('withBalance', 'Users with Balance');
    }
    ...
    {
        $request->validate([
            'action' => 'required|in:banned,unbanned,mobile_verified,email_verified,kyc_verified',
