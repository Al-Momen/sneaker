        ...
        <div class="col-lg-12 mt-5">
            <div class="row gy-4">
                <div class="col-sm-6 col-xxl-3 col-xl-3">
                    <a class="dashboard-widget--card position-relative" href="{{ route('admin.deposit.log', ['status' => 'approved']) }}">
                ...
                <div class="col-sm-6 col-xxl-3 col-xl-3">
                    <a class="dashboard-widget--card position-relative" href="{{ route('admin.deposit.log', ['status' => 'pending']) }}">
                        <div class="dashboard-widget__icon">
                ...
                <div class="col-sm-6 col-xxl-3 col-xl-3">
                    <a class="dashboard-widget--card position-relative" href="{{ route('admin.deposit.log', ['status' => 'rejected']) }}">
                        <div class="dashboard-widget__icon">
                ...
                <div class="col-sm-6 col-xxl-3 col-xl-3">
                    <a class="dashboard-widget--card position-relative" href="{{ route('admin.deposit.log', ['status' => 'initiated']) }}">
                        <div class="dashboard-widget__icon">
                            <i class="dashboard-card-icon fa-solid fa-check-to-slot"></i>
                        </div>
                        <div class="dashboard-widget__content">
    ...
    <div class="row gy-4 justify-content-between mb-3 pb-3">
        <div class="col-xl-8 col-lg-6">
            <div class="d-flex flex-wrap justify-content-start">
                <form class="d-flex gap-3 flex-wrap align-items-center justify-content-start">
        ...
        (function ($) {
            ...
            $('#table__data__filter').on('change', function () {
                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        $('#items_table__body').html('<tr><td colspan="8">Loading...</td></tr>');
                    },
