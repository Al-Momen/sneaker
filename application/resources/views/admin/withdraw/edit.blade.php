                    ...
                    <div class="row gy-4 mb-2">
                        <div class="col-lg-4 col-sm-12">
                            <div class="card border my-2">
                                ...
                                <div class="card-body">
                                    <x-image-uploader name="image" :imagePath="getImage(getFilePath('withdrawMethod') . '/' . $method->image ,getFileSize('withdrawMethod'))" :size="getFileSize('withdrawMethod')" :isImage="true" class="w-100" id="uploadLogo3" :required="false" />
                                </div>
                            </div>
                        </div>
