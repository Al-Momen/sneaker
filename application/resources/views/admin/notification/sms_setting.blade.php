                ...
                <div class="card p-16 br--solid radius--base bg--white">
                    <form action="" method="POST">
                        ...
                        <div class="row mt-4 d-none configForm" id="nexmo">
                            <div class="col-md-12">
                                <h6 class="mb-4 fw-bold">@lang('Nexmo Configuration')</h6>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 d-none configForm" id="twilio">
                            <div class="col-md-12">
                                <h6 class="mb-4 fw-bold">@lang('Twilio Configuration')</h6>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row mt-4 d-none configForm" id="custom">
                            <div class="col-md-12">
                                <h6 class="mb-4 fw-bold">@lang('Custom API')</h6>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <hr class="my-4">
                            <div class="row">
                                <div class="col-md-12 d-flex gap-3 mb-4">
                                    <h6>Short Code:</h6>
                                            ...
                                            <div class="headerFields">
                                                @for ($i = 0; $i < count($general->sms_config->custom->headers->name); $i++)
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button type="button"
                                                                class="btn btn--danger btn-block removeHeader h-100"><i class="fa-solid fa-xmark"></i></button>
                                                        </div>
                                                    </div>
                                                @endfor
                                            </div>
