                                            ...
                                            <td>
                                                <div class="button--group">
                                                    @if ($section->element->modal)
                                                        ...
                                                        @endphp
                                                        <button title="@lang('Edit')" class="btn btn-sm btn--primary updateBtn" data-id="{{ $data->id }}" data-all="{{ json_encode($data->data_values) }}" @if (!empty($section->element->images)) data-images="{{ json_encode($images) }}" @endif>
                                                            <i class="fa-solid fa-pen-to-square"></i>

                                                        </button>
                                                    @else
                                                        <a title="@lang('Edit')" href="{{ route('admin.frontend.sections.element', [$key, $data->id]) }}" class="btn btn-sm btn--primary">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                        </a>
                                                    @endif
                                                ...
                                                <div class="image-upload">
                                                    <div class="thumb">
                                                        ...
                                                        <div class="avatar-edit">
                                                            ...
                                                            <label for="addImage{{ $loop->index }}" class="bg--primary">{{ __(keyToTitle($imgKey)) }}</label>
                                                            <small class="mt-2 ">
                                                ...
                                                <div class="image-upload">
                                                    <div class="thumb">
                                                        ...
                                                        <div class="avatar-edit">
                                                            ...
                                                            <label for="fileUploader{{ $loop->index }}" class="bg--primary">{{ __(keyToTitle($imgKey)) }}</label>
                                                            <small class="mt-2  ">
                                                                @if ($section->element->images->$imgKey->size)
                                                                    @lang('Recomended size:'):
                                                                    <b>{{ $section->element->images->$imgKey->size }}</b>
