...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12">
            <div class="bg--white radius--base p-16">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">@lang('KYC Form for User')</h5>
                    <button type="button" class="btn btn--primary float-end form-generate-btn"><i
                            ...
                            @if ($form)
                                @foreach ($form->form_data as $formData)
                                    ...
                                    <div class="col-xl-4 col-md-6 mb-4">
                                        <div class="card border" id="{{ $loop->index }}">
                                            ...
                                            <div class="card-body">
                                                <div
                                                    class="button--group d-flex align-items-center justify-content-end gap-2">
                                                    <button type="button" class="edit--btn editFormData"
