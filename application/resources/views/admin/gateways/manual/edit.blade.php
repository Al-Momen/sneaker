                    ...
                    <div class="payment-method-item">
                        <div class="row mt-4">
                            <div class="col-lg-4 col-sm-12">
                                <x-image-uploader name="image" :imagePath="getImage(getFilePath('paymentGateway') . '/' . $method->image ,getFileSize('paymentGateway'))" :size="getFileSize('paymentGateway')" :isImage="true" class="w-100" id="uploadLogo3" :required="false" />
                            </div>
                                        ...
                                        <div class="card border">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" name="percent_charge" value="{{ getAmount($method->singleCurrency->percent_charge ?? 0) }}" min="0" step="any" required>
                                ...
                                <div class="col-lg-12">
                                    <div class="card border mt-3">
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-sm bg--primary float-end form-generate-btn">
                                                    ...
                                                    <div class="card border mb-3" id="{{ $loop->index }}">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group text-end">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn--danger removeFormData"><i class="fa-solid fa-xmark"></i></button>
                                                            </div>
                                                            <div class="form-group">
