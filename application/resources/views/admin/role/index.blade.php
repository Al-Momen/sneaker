...
@push('breadcrumb-plugins')
    <a class="btn btn--primary add__btn" href="javascript:void(0)"
        data-action="{{ route('admin.role.store', ['id' => 0]) }}"><i class="fa-solid fa-user-plus"></i>
        @lang('Add Role')</a>
@endpush
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                modal.find('#editBtn').text(`{{ __('Update') }}`);
            ...
            $('#status-filter').on('change', function() {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $('#items_table__body').html('<tr><td colspan="3" class="text-center">Loading...</td></tr>');
                    },
