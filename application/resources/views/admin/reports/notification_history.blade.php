                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    <tr>
                                                ...
                                                <div class="d-flex justify-content-between justify-content-lg-start gap-3">
                                                    <div class="user--info d-flex gap-3 flex-shrink-0 align-items-center flex-wrap flex-md-nowrap">
                                                        ...
                                                        <div class="user--content">
                                                            <a class="text-start" href="{{ route('admin.users.detail', $log->user_id) }}">
                                                                {{ $log->user->fullname }}
                                                            </a>
                                                            <p class="text-start">
                                                                {{ '@'.$log->user?->username ?? ''}}
                                            ...
                                            @else
                                                ...
                                                <div class="d-flex justify-content-between justify-content-lg-start gap-3">
                                                    <div
                                                        ...
                                                        <div class="user--thumb-two">
                                                            <img src="{{ getImage(getFilePath('userProfile') . '/avatar.png') }}" alt="@lang('Image')">
                                                        </div>
                                                        <div class="user--content">
                                        ...
                                        <td>
                                            <button title="@lang('Details')" class="edit--btn bg--transparent notifyDetail btn btn--sm"
                                                ...
                                                data-sent_to="{{ $log->sent_to }}" target="_blank"><i class="fa-solid fa-eye"></i></button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
