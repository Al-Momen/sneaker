                            ...
                            <tbody>
                                @forelse ($languages as $item)
                                    <tr>
                                        <td>{{ __($item->name) }}</td>
                                        <td>
                                            <img src="{{ getImage(getFilePath('language') . '/' . $item->icon ?? '', getFileSize('language')) }}"
                                                alt="{{ $item->name }}" style="width:30px; border-radius:50%;">
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a title="@lang('Translate')"
                                                    href="{{ route('admin.language.key', $item->id) }}" class="btn btn-sm">
