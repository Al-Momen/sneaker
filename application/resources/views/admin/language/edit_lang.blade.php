                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive--sm table-responsive mb-4">
                            <table class="table table--light style--two custom-data-table white-space-wrap" id="myTable">
                                <thead>
                                    <tr>
                                        <th>
                                            @lang('Key')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a title="@lang('Edit')" href="javascript:void(0)"
                                                    ...
                                                    data-value="{{ $language }}" class="editModal btn btn-sm">
...
@push('breadcrumb-plugins')
    <button type="button" class="btn btn-sm btn--primary box--shadow1 importBtn">
        <i class="fa-solid fa-file-import"></i>@lang('Import Keywords')
    </button>
@endpush
