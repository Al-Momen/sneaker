                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-between mt-3">
                        ...
                        <div class="col-md-5 mt-md-0 mt-3">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#searchModal" class="btn btn-sm btn--primary float-end">
                                <i class="fas fa-search"></i> @lang('Search Key')
                            </button>

                            <button type="button" data-bs-toggle="modal" data-bs-target="#searchAndReplaceModal" class="btn btn-sm btn--primary float-end me-2">
                                <i class="fas fa-exchange-alt"></i> @lang('Search And Replace')
                            </button>

                            <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                                class="btn btn-sm btn--primary float-end me-2"><i class="fa fa-plus"></i> @lang('Add New Key') </button>
                        </div>
                    </div>
                    <hr>
