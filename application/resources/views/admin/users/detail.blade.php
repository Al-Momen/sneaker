        ...
        <div class="col-12">
            <div class="row mb-5">
                <div class="user-profile--wrap">
                    <div class="user-profile--banner bg--img" style="background-image: url({{ getImage('assets/images/general/user-banner.png') }})">
                                    ...
                                    <div class="col-xl-2 col-lg-12">
                                        <div class="d-flex justify-content-lg-end">
                                            <a class="d-block btn btn--secondary outline"
                                                ...
                                                <i class="fa-solid fa-arrow-right-to-bracket"></i> @lang('Login as User')
                                            </a>
                                        </div>
                                    </div>
                                </div>
