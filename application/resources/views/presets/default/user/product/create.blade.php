    ...
    <div class="row gy-4 justify-content-center">
        <div class="col-md-12 justify-content-center">
            <div class="base--card bg--white border--none radius--8">
                <form id="productCreateForm" action="{{ route('user.product.store') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <label for="discount" class="form--label mb-2">@lang('Discount')(%)</label>
                            <div class="input-group">
                                <input type="number" name="discount" id="discount" min="0" max="100"
                                    step="any" value="{{ old('discount') }}"
                                    class="form--control form-control bg--white " placeholder="@lang('Product Discount')">
        ...
        $(document).ready(function() {
            ...
            $("select[name='type']").on('change', function() {
                if ($(this).val() == 1) {
                    ...
                    $('input[name=is_color]').val(1).prop('checked', false);
