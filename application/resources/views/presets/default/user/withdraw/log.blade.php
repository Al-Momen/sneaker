                            ...
                            <div class="base--card bg--white border--none radius--8 tbl-wrap">
                                <table class="table table--responsive--lg">
                                    ...
                                    <tbody id="items_table__body">
                                        @include('Template::components.user.tables.withdraw_history_data')
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        <div id="pagination-wrapper"
                            class="pagination__wrapper py-4 {{ $withdraws->hasPages() ? '' : 'd-none' }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                           <button type="button" class="btn btn--danger btn--md pills"
...
@push('script')
    ...
    <script>
        (function($) {
            "use strict";
            let baseUrl = `{{ route('user.withdraw.history', ':status') }}`;
