        ...
        <div class="col-lg-12">
            <div class="base--card bg--white border--none radius--8">
                <div class="text-end mb-3">
                    <a href="{{route('ticket') }}" class="btn btn--lg btn--base mb-2 pills">@lang('My Support Ticket')</a>
                </div>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="message" id="inputMessage" rows="6" class="form-control form--control" placeholder="@lang('Message')"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="text-end">
                                    <button type="button" class="btn btn--base btn--lg btn--md pills addFile">
                        ...
                        <div class="col-lg-12">
                            <div class="text-end">
                                <button class="btn btn--base btn--lg pills w-100" type="submit" id="recaptcha">@lang('Submit')</button>
                            </div>
                        </div>
                    </div>
                </form>
