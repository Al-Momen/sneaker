                    ...
                    <div class="verification-code-wrapper">
                        <div class="verification-area">
                            <form action="{{ route('user.verify.mobile') }}" method="POST" class="submit-form">
                                @csrf
                                <p class="verification-text text--white mb-3">@lang('A 6 digit verification code sent to your mobile number') :
                                ...
                                <div class="form-group">
                                    <p class="text--white">
                                        @lang('If you don\'t get any code'), <a class="text--white text--underline" href="{{ route('user.send.verify.code', 'phone') }}"
