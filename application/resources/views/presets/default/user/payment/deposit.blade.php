            ...
            <div class="base--card bg--white border--none radius--8">
                <form action="{{ route('user.deposit.insert') }}" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label class="form--label mb-2">@lang('Select Gateway')</label>
                        <select class="form--control from-select" name="gateway" required>
                    ...
                    <div class="form-group mb-3">
                        <label class="form--label mb-2">@lang('Amount')</label>
                    ...
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn--base btn--lg w-100 mt-3">
                            @lang('Submit')
                        </button>
                    </div>
                </form>
