...
<div class="row mb-4 mx-0">
    <div class="dashboard-header d-flex justify-content-between align-items-center radius--8">
        ...
        <div class="user-info--wrap d-flex align-items-center gap--16">
            <a href="#" class="u-info dropdown-toggle d-flex align-items-center gap--12" data-bs-toggle="dropdown"
                aria-expanded="false">
                ...
                <div class="user--name d-flex align-items-center gap--12">
                    <div>
                        <h6 class="user--name text--black mb-1 fs--14">
                            {{ $user->fullname ?? '' }}
                        </h6>
                        {{-- <p class="user--role text--black7 text--sm">Admin</p> --}}
                    </div>
