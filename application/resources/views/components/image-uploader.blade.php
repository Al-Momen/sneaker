...
<div class="image-upload--container br--dark radius--base d-flex flex-column justify-content-center align-items-center">
   ...
   <script>
        $(function () {
            ...
            $('.image-upload--container').each(function () {
                ...
                $browseTrigger.off('click').on('click', () => $fileInput.click());
