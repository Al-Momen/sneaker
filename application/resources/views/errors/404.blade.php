            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="error__main py-60">
                        <img src="{{ getImage(getFilePath('error') . '404.png') }}" alt="image">
                        <h2>404</h2>
                        <h4>@lang('Page Not Found')</h4>
                        <p>@lang("The page you are looking for might have been removed had its name changed or is temporarily unavailable.")</p>
